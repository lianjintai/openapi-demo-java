...
public class AddCollPrDemo {
  ...
  public String collPrParams() {
    ...
    appCollPrVO.setPrBasicInfo(prBasicInfo);
    ...
    appCollPrVO.setPrConsttInfo(prConsttInfo);
    ...
    appCollPrVO.setPrLandInfo(prLandInfo);
    ...
    appCollPrVO.setPrLeaseInfo(prLeaseInfoVO);
    ...
    appCollPrVO.setPrRecordInfo(prRecordInfoVO);
    ...
    appCollPrVO.setCsCollOwner(csCollOwner);
    /*
     * 苏有着信息（企业）
     */
    ...
    appCollPrVO.setCsCollOwner(cpCollOwner);
    /*
     * 外部评估信息
     */
    ...
    appCollPrVO.setAppCollEvaluate(appCollEvaluate);

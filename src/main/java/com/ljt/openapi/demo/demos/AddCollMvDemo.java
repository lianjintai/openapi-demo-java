...
public class AddCollMvDemo {
  ...
  public String collMvParams() {
    ...
    appCollMvApiVO.setMvBasicInfo(basicInfoVO);
    ...
    appCollMvApiVO.setMvConfInfo(confInfoVO);
    ...
    appCollMvApiVO.setMvInsuranceInfo(insuranceInfo);
    ...
    appCollMvApiVO.setMvPaymentInfo(mvPaymentInfoVO);
    ...
    appCollMvApiVO.setMvPenaltyInfo(mvPenaltyInfoVO);
    ...
    appCollMvApiVO.setCsCollOwner(csCollOwner);
    ...
    appCollMvApiVO.setCsCollOwner(cpCollOwner);
    ...
    appCollMvApiVO.setAppCollEvaluate(appCollEvaluate);

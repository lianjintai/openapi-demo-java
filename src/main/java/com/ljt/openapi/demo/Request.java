...
public class Request {
  ...
  public Request(Method method, String host, String path, String appKey, String appSecret,
      int timeout) {
    this.method = method;
    this.host = host;
    this.path = path;
  ...
  /**
   * （必选）超时时间,单位毫秒,设置零默认使用com.ljt.openapi.demo.constant.Constants.DEFAULT_TIMEOUT
   */
  private int timeout;
